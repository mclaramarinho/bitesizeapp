...
class DsThemes {
  ...
  // TODO (fix) - still does not look good
  ...
  static ThemeData get freeDark {
    ...
    return ThemeData(
      ...
      scaffoldBackgroundColor:
          DsColors.blue.deepSlateObsidian, // Deep slate obsidian
      ...
      cardTheme: CardThemeData(
        ...
        shape: RoundedRectangleBorder(
          ...
          borderRadius: const BorderRadius.all(
            Radius.circular(DsSpacing.sm),
          ), // Sharper retro corners
        ),
      ),
      appBarTheme: AppBarTheme(
        backgroundColor: Colors.transparent,
  ...
  static ThemeData get premiumCyberpunk {
    ...
    return ThemeData(
      ...
      checkboxTheme: CheckboxThemeData(
        ...
        shape: const RoundedRectangleBorder(
          borderRadius: BorderRadius.all(Radius.circular(DsSpacing.xxs)),
        ),
      ),
    );
  }
